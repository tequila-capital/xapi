...
class MarketDataService(object):
    ...
    @staticmethod
    def GetOptionChainForUnderlier(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def GetOptionSymbolFromDescription(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def GetDescriptionFromOptionSymbol(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def GetSymbolFromAlternateSymbology(
        request,
        target,
        options=(),
        channel_credentials=None,
